...
void Demo::Render() {
	...
	glm::vec3 cameraPos = glm::vec3(0, 2.2, 3);
	glm::vec3 cameraFront = glm::vec3(-0.5, 0, 0);
...
void Demo::BuildLemari()
{
	...
	float vertices[] = {
		...
		// front
		-2.5, -1.5, 0.5, 0, 0, 0.0f,  0.0f,  1.0f, // 0
		0.5, -1.5, 0.5, 1, 0, 0.0f,  0.0f,  1.0f,   // 1
		0.5,  1.5, 0.5, 1, 1, 0.0f,  0.0f,  1.0f,   // 2
		-2.5,  1.5, 0.5, 0, 1, 0.0f,  0.0f,  1.0f,  // 3

		// right
		0.5,  1.5,  0.5, 0, 0,  0.0f,  0.0f,  1.0f,  // 4
		0.5,  1.5, -0.5, 1, 0,  0.0f,  0.0f,  1.0f,  // 5
		0.5, -1.5, -0.5, 1, 1,  0.0f,  0.0f,  1.0f,  // 6
		0.5, -1.5,  0.5, 0, 1,  0.0f,  0.0f,  1.0f,  // 7

		// back
		-2.5, -1.5, -0.5, 0, 0,  0.0f,  0.0f,  1.0f, // 8 
		0.5,  -1.5, -0.5, 1, 0,  0.0f,  0.0f,  1.0f, // 9
		0.5,   1.5, -0.5, 1, 1,  0.0f,  0.0f,  1.0f, // 10
		-2.5,  1.5, -0.5, 0, 1,  0.0f,  0.0f,  1.0f, // 11

		// left
		-2.5, -1.5, -0.5, 0, 0,  0.0f,  0.0f,  1.0f, // 12
		-2.5, -1.5,  0.5, 1, 0,  0.0f,  0.0f,  1.0f, // 13
		-2.5,  1.5,  0.5, 1, 1,  0.0f,  0.0f,  1.0f, // 14
		-2.5,  1.5, -0.5, 0, 1,  0.0f,  0.0f,  1.0f, // 15

		// upper
		0.5, 1.5,  0.5, 0, 0,  0.0f,  0.0f,  1.0f,   // 16
		-2.5, 1.5,  0.5, 1, 0,  0.0f,  0.0f,  1.0f,  // 17
		-2.5, 1.5, -0.5, 1, 1,  0.0f,  0.0f,  1.0f,  // 18
		0.5, 1.5, -0.5, 0, 1,  0.0f,  0.0f,  1.0f,   // 19

		
		// bottom
		-2.5, -0.5, -0.5, 0, 0, 0.0f,  0.0f,  1.0f,// 20
		0.5, -0.5, -0.5, 1, 0,  0.0f,  0.0f,  1.0f,// 21
		0.5, -0.5,  0.5, 1, 1,  0.0f,  0.0f,  1.0f,// 22
		-2.5, -0.5,  0.5, 0, 1,  0.0f,  0.0f,  1.0f,// 23
